...
export async function PUT(req, {params}) {
    ...
    await Job.findOneAndUpdate({ title: careertitle }, { title, keywords, jobTitle, jobType, experience, location, details, applying, requests, status, titleAr, jobTitleAr, jobTypeAr, detailsAr })
...
export async function DELETE(req, {params}) {
    const { careertitle } = params
    await connectMongoDB()
    await Job.findOneAndDelete({ title: careertitle })
