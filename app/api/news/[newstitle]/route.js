...
export async function PUT(req, { params }) {
    ...
    await News.findByIdAndUpdate(newstitle, { title, titleAr, keyword, keywordAr, description, descriptionAr, date, images, details, detailsAr })
...
export async function DELETE(req, { params }) {
    const { newstitle } = params
    await connectMongoDB()
    await News.findByIdAndDelete(newstitle)
