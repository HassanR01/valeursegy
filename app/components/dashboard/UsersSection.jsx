...
export default function UsersSection({ users }) {
  ...
  return (
    <>
      ...
      <div onClick={() => setAddUesrForm(!addUserForm)} className={`ShowBtn fixed bottom-5 right-5 p-3 cursor-pointer bg-whiteColor rounded-xl ${addUserForm ? "text-green-500" : "text-bgColor"}`}>
