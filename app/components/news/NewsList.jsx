        ...
        return (
            <>
                <div className="newsList w-full flex flex-wrap items-center justify-around">
                    {news.map((now, ind) => (
                        <TransitionLink href={`/news/${now.title}`} className="now cursor-pointer hover:shadow-xl duration-500 relative w-full lg:w-[45%] min-w-[300px] h-[320px] rounded-tr-xl rounded-bl-xl overflow-hidden m-4" key={ind}>
