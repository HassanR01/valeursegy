    ...
    return (
        <footer className='w-full p-8 flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between relative min-h-[50vh]' style={{
            ...
            <div className="links flex my-8 flex-col items-center text-center lg:text-start lg:items-start justify-center z-10">
                ...
                <div className="followUs w-full flex flex-col items-start justify-start">
                    ...
                    <div className="links ml-0 flex justify-around items-center flex-row">
                        <Link className='mr-3 hover:scale-125 duration-500' href={"https://www.facebook.com/valeurs.eg"} target='_blank'><Image src={'/facebookIcon.png'} width={30} height={30} alt='Facebook Icon' /></Link>
