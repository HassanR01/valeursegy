        ...
        <div className={`menu duration-700 absolute flex flex-col items-center justify-center top-0 p-4 h-screen bg-whiteColor z-40 ${openMenu ? "right-0 w-full rounded-none" : "rounded-xl -right-[270px] w-[270px]"}`}>
          <nav>
            <ul className='h-full'>
              ...
              <motion.li initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 1.7 }} onClick={() => setOpenMenu(false)}><TransitionLink className={`p-1 mx-4 my-4 text-mainColor flex items-center justify-center font-bold text-center text-2xl hover:scale-125 duration-700 lg:text-3xl`} href={'/ar/news'}>أخبارنا</TransitionLink></motion.li>
