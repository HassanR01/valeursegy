    ...
    >
      ...
      <div className="preMenu bg-black w-full p-1">
        <nav>
          <ul className='flex items-center justify-end'>
            ...
            <li><TransitionLink className={`mx-4`} href={'/partenerships'}>Partnerships</TransitionLink></li>
      ...
      <div className="mainMenu w-full flex items-center justify-center relative h-full">
        <div className="title absolute top-0 left-0 w-full flex items-center justify-between p-3">
          ...
          <div onClick={() => translatePage()} className={`menuIcon p-2 rounded-full cursor-pointer flex items-center justify-center text-mainColor bg-whiteColor z-50`}>
